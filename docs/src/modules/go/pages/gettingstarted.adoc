...
--proto_path=protobuf ./protobuf/*.proto`, you'll find your generated protobuf files in `example/shoppingcart`.
...
[source,go]
----
include::example$tck/cmd/tck_shoppingcart/shoppingcart.go[tag=shopping-cart-main]
----
...
[source,go]
----
include::example$cloudstate/eventsourced.go[tag=event-sourced-entity-func]
----
